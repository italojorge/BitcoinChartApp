...
object BitcoinLastValueRemoteMapper :
    DataRemoteMapper<BitcoinLastValueResponse, BitcoinLastValue>() {
    override fun toDomain(data: BitcoinLastValueResponse): BitcoinLastValue {
        return BitcoinLastValue(data.usdResponse?.lastBitcoinValue ?: DOUBLE_ZERO_VALUE)
    }
}